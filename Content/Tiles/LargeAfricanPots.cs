...
public class LargeAfricanPots : ModTile
{
    ...
    public override void KillMultiTile(int x, int y, int frameX, int frameY)
    {
        ...
        if (frame == 0)
            item = ModContent.ItemType<Items.AfricanPot1>();
        else if (frame == 1)
            item = ModContent.ItemType<Items.AfricanPot2>();
        else if (frame == 2)
            item = ModContent.ItemType<Items.AfricanPot3>();
        else if (frame == 3)
            item = ModContent.ItemType<Items.AfricanPot4>();
        else if (frame == 4)
            item = ModContent.ItemType<Items.AfricanPot5>();
