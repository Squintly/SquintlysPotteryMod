...
public class LargeNativePots : ModTile
{
    ...
    public override void KillMultiTile(int x, int y, int frameX, int frameY)
    {
        ...
        if (frame == 0)
            item = ModContent.ItemType<Items.NativePot1>();
        else if (frame == 1)
            item = ModContent.ItemType<Items.NativePot2>();
        else if (frame == 2)
            item = ModContent.ItemType<Items.NativePot3>();
        else if (frame == 3)
            item = ModContent.ItemType<Items.NativePot4>();
        else if (frame == 4)
            item = ModContent.ItemType<Items.NativePot5>();
        else if (frame == 5)
            item = ModContent.ItemType<Items.NativePot6>();
        else if (frame == 6)
            item = ModContent.ItemType<Items.NativePot7>();
