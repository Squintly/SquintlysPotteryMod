...
public class MediumAztecPots : ModTile
{
    ...
    public override void KillMultiTile(int x, int y, int frameX, int frameY)
    {
        ...
        if (frame == 0)
            item = ModContent.ItemType<Items.AztecPot8>();
        else if (frame == 1)
            item = ModContent.ItemType<Items.AztecPot9>();
        else if (frame == 2)
            item = ModContent.ItemType<Items.AztecPot10>();
        else if (frame == 3)
            item = ModContent.ItemType<Items.AztecPot11>();
        else if (frame == 4)
            item = ModContent.ItemType<Items.AztecPot12>();
