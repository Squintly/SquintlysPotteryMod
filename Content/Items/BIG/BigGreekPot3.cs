...
namespace SquintlysPotteryMod.Content.Items.BIG
{
	public class BigGreekPot3 : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Gargantuan Meditteranian Pot");
            
			CreativeItemSacrificesCatalog.Instance.SacrificeCountNeededByItemId[Type] = 1;
		}

		public override void SetDefaults() {
			Item.createTile = ModContent.TileType<Tiles.BIG.BigThickPots>(); // This sets the id of the tile that this item should place when used.
            Item.placeStyle = 7;

            Item.width = 29; // The item texture's width
