...
{
	public class AfricanPot10 : ModItem
	{
		...
		public override void SetDefaults() {
			Item.createTile = ModContent.TileType<Tiles.MediumAfricanPots>(); // This sets the id of the tile that this item should place when used.
            Item.placeStyle = 4;
