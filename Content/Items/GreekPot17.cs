...
{
	public class GreekPot17 : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Small Meditteranian Pot");
            
			CreativeItemSacrificesCatalog.Instance.SacrificeCountNeededByItemId[Type] = 1;
		}

		public override void SetDefaults() {
			Item.createTile = ModContent.TileType<Tiles.SmallGreekPots>(); // This sets the id of the tile that this item should place when used.
            Item.placeStyle = 4;
